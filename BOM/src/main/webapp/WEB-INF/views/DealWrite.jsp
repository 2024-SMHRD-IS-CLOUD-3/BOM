			...
			<table id="list">
				<tr>
					...
					<td><select name="category">
						<option value="장난감" name="category">장난감</option>
                        <option value="분유" name="category">분유</option>
                        <option value="기저귀" name="category">기저귀</option>
                        <option value="도서" name="category">도서</option>
                        <option value="교구" name="category">교구</option>
					</td>
				</tr>
				...
				<tr>
					...
					<td>	${empty deal.id ? '로그인해주세요' : deal.id}</td>
				</tr>
				<tr>
					<td colspan="2">내용</td>
				</tr>
				<tr>
					<td colspan="2">
						...
						<div class="preview-container" id="preview-container"></div> <textarea
							rows="10" style="resize: none;" name="b_content"></textarea>
					</td>
				</tr>
				<tr>
