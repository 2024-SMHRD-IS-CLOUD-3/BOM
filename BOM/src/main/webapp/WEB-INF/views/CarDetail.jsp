...
<body>
	<header>
		...
		<nav>
			...
			<div class="dropdown-content">
				<a href="car">유모차 판매</a> <a href="goCar">유모차 구매</a>
		...
		<div class="product-container">
			<div class="slider">
				<div class="slides">
					...
					<img src="stroller/${car.car_file}" id="product-image"
			...
			<div class="product-details">
				...
				<p id="product-description" class="description"
					style="white-space: pre-line;">${car.car_content}</p>
			</div>
