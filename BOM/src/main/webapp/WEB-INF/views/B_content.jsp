...
<link rel="stylesheet" href="B_content.css" media="screen">
...
<script type="application/ld+json">{
    ...
    function submitForm() {
        document.getElementById('SubmitWriter').submit();
    }
    ...
    function submitForm() {
        var form = document.getElementById('SubmitWrite');
        if (form) {
            form.submit();
        } else {
            console.error('Form with id "SubmitWrite" not found.');
        }
    }

</script>
<meta name="theme-color" content="#478ac9">
<meta property="og:title" content="B_content">
<meta property="og:type" content="website">
<meta data-intl-tel-input-cdn-path="intlTelInput/">
</head>
<body data-path-to-root="./" data-include-products="true"
    ...
    source="custom" name="form" style="padding: 10px;" method="post">
					...
					<div class="u-form-group u-label-top u-form-group-2">
						<label for="text-eb56" class="u-label">제목</label> <input
					...
					<div class="u-form-group u-label-top u-form-group-3">
						<label for="text-db2a" class="u-label">가격</label> <input
					...
					<div class="u-form-group u-form-message u-label-top u-form-group-4">
						<label for="message-4439" class="u-label">내용</label>
